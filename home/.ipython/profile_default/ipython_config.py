...
# c.TerminalInteractiveShell.banner1 = 'Python 2.7.6 (default, Apr  9 2014, 11:48:19) \nType "copyright", "credits" or "license" for more information.\n\nIPython 2.0.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
c.PromptManager.out_template = u'{color.LightRed}╭ ( ･ㅂ･)و ! [\#{color.LightRed}]: '
...
c.PromptManager.in_template = u'{color.LightCyan}\\w\n {color.LightBlue}(灬╹ω╹灬) ? [\#{color.LightBlue}]: '
